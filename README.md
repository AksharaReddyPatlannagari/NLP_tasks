...
This repository contains code for a multi-task NLP assessment. It includes tasks such as sentence classification and named entity recognition (NER), with all the necessary dependencies, Docker container setup, and explanations included. 
